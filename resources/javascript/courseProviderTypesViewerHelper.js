...
var CourseProviderTypesViewerHelper = {
		remove : function (row) {
			...
			LazyLoader.loadMultiple(['/dwr/engine.js', '/dwr/interface/CourseProviderTypesViewerBean.js'], function() {
				CourseProviderTypesViewerBean.remove(id);
			});
