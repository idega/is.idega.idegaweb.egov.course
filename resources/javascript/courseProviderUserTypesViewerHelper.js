...
var CourseProviderUserTypesViewerHelper = {
	remove : function (row) {
		...
		LazyLoader.loadMultiple(['/dwr/engine.js', '/dwr/interface/CourseProviderUserTypesViewerBean.js'], function() {
			CourseProviderUserTypesViewerBean.remove(id);
		});
