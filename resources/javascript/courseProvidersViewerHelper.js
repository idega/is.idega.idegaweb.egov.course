...
var CourseProvidersViewerHelper = {
	remove : function (row) {
		...
		LazyLoader.loadMultiple(['/dwr/engine.js', '/dwr/interface/CourseProviderViewerBean.js'], function() {
			CourseProviderViewerBean.remove(id);
		});
