/**
 * @(#)CourseProviderUserHome.java    1.0.0 11:54:28 AM
 *
...
/**
 * <p>EJB data access object for </p>
 ...
 */
public interface CourseProviderUserHome extends IDOHome {
	public CourseProviderUser findForUser(User user);

	/**
	 * 
	 * @param school to search by, not <code>null</code>;
	 * @return {@link User}s for selected {@link CourseProvider} or 
	 * {@link Collections#emptyList()} on failure;
	 * @author <a href="mailto:martynas@idega.is">Martynas Stakė</a>
	 */
	public Collection<? extends CourseProviderUser> findBySchool(CourseProvider school);

	/**
	 * 
	 * @param providers to search by, not <code>null</code>;
	 * @return {@link User}s for selected {@link CourseProvider}s or 
	 * {@link Collections#emptyList()} on failure;
	 * @author <a href="mailto:martynas@idega.is">Martynas Stakė</a>
	 */
	...
	/**
	 * 
	 * @param primaryKey is {@link CourseProviderUser#getPrimaryKey()}, 
	 * not <code>null</code>;
	...
	/**
	 * 
	 * @param types to find {@link CourseProviderUser}s by, not <code>null</code>;
	 ...
	 * 
	 * <p>Creates/updates {@link CourseProviderUser} in data source.</p>
	 * @param user is existing {@link CourseProviderUser} to update,
	 * new one will be created if <code>null</code>;
	 * @param idegaUser is {@link User} whom this wrapper should be created.
	 * If <code>null</code> and {@link CourseProviderUser} does not exist,
	 ...
	 * to remove relation from, not <code>null</code>;
	 * @param courseProviderId is {@link CourseProvider#getPrimaryKey()} to 
	 * remove, if not provided, all {@link CourseProvider}s from relation
	 * will be removed;
	 * @author <a href="mailto:martynas@idega.is">Martynas Stakė</a>
	 */
