...
public interface CourseCertificateHome extends IDOHome {
	...
	public Collection<CourseCertificate> findAllCertificatesByUser(User user) throws FinderException;

	public Collection<CourseCertificate> findAllCertificatesByUserAndCourse(User user, Course course) throws FinderException;
