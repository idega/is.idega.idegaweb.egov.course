/**
 * @(#)CourseProviderType.java    1.0.0 3:36:49 PM
 *
...
/**
 * <p>Data access object for {@link CourseProviderType}</p>
...
public interface CourseProviderTypeHome extends IDOHome {
	 ...
	 * @author <a href="mailto:martynas@idega.is">Martynas Stakė</a>
	 */
	public Collection<? extends CourseProviderType> findByCategories(
