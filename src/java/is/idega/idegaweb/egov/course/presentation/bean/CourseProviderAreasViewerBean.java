...
public class CourseProviderAreasViewerBean {
	...
	public List<CourseProviderAreaBean> getCourseProviders() {
		...
		ArrayList<CourseProviderAreaBean> beans = new ArrayList<CourseProviderAreaBean>(courseProviders.size());
		for (CourseProviderArea courseProvider : courseProviders) {
			beans.add(new CourseProviderAreaBean(courseProvider));
		}
	...
	public String getEditorLink() {
		return BuilderLogic.getInstance().getUriToObject(CourseProviderAreaEditor.class);
	}
