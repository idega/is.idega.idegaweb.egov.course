/**
 * @(#)CourseProviderTypesViewer.java    1.0.0 2:14:39 PM
 *
...
/**
 * <p>Viewer component for {@link CourseProviderType}</p>
 ...
 */
public class CourseProviderTypesViewer extends IWBaseComponent {
	public static final String FACELET_FILENAME = "course_provider_types_viewer.xhtml";
	...
	protected void initializeComponent(FacesContext context) {
		...
		if (iwc.isLoggedOn()) {
			...
			add(new Text(getLocalizedString(context, 
