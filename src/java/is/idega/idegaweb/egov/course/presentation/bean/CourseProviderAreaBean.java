 ...
 */
public class CourseProviderAreaBean {

	public static final String COURSE_PROVIDER_AREA_ID = "course_provider_area_id";
	...
	public CourseProviderAreaBean() {}
	
	public CourseProviderAreaBean(CourseProviderArea courseProviderArea) {
		this.courseProviderArea = courseProviderArea;
	}
	...
	public String getId() {
		...
		return getCourseProviderArea().getPrimaryKey().toString();
	}
	...
	public String getName() {
		...
		return getCourseProviderArea().getName();
	}
	...
	public String getAddress() {
		...
		return getCourseProviderArea().getSchoolAreaCity();
	}
	...
	public String getInfo() {
		...
		return getCourseProviderArea().getSchoolAreaInfo();
	}
	...
	public String getAccountingId() {
		...
		return getCourseProviderArea().getAccountingKey();
	}
	...
	public CourseProviderArea getCourseProviderArea() {
		if (this.courseProviderArea == null) {
			String courseProviderAreaId = CoreUtil.getIWContext()
					.getParameter(COURSE_PROVIDER_AREA_ID);
			if (!StringUtil.isEmpty(courseProviderAreaId)) {
				this.courseProviderArea = getCourseProviderAreaHome().find(courseProviderAreaId);
			}
		}
		
		return this.courseProviderArea;
	}

	public void setCourseProviderArea(CourseProviderArea courseProviderArea) {
		this.courseProviderArea = courseProviderArea;
	}
	...
	public String getEditorLink() {
		...
		parameters.add(new AdvancedProperty(
				COURSE_PROVIDER_AREA_ID, 
				getCourseProviderArea().getPrimaryKey().toString()));
		return BuilderLogic.getInstance().getUriToObject(
				CourseProviderAreaEditor.class, 
				parameters
				);
	}
