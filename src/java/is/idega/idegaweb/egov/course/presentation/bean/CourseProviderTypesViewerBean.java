/**
 * @(#)CourseProviderTypesViewerBean.java    1.0.0 2:20:29 PM
 *
...
import is.idega.idegaweb.egov.course.presentation.CourseProviderTypesViewer;
...
/**
 * <p>JSF Managed bean for {@link CourseProviderTypesViewer}</p>
...
public class CourseProviderTypesViewerBean {
	...
	public List<CourseProviderTypeBean> getTypes() {
		...
		if (!ListUtil.isEmpty(types)) {
			List<CourseProviderTypeBean> typeBeans = new ArrayList<CourseProviderTypeBean>();
			for (CourseProviderType type : types) {
				typeBeans.add(new CourseProviderTypeBean(type));
			}
	...
	public String getEditorLink() {
		return BuilderLogic.getInstance().getUriToObject(CourseProviderTypeEditor.class);
	}
