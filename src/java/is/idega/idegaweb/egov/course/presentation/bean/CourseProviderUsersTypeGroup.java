/**
 * @(#)CourseProviderGroupedUsersBean.java    1.0.0 1:26:21 PM
 *
...
/**
 * <p>Bean for {@link CourseProviderUsersViewerBean} to provide 
 * {@link CourseProviderUser}s by {@link CourseProviderUserType#getName()}.</p>
 * <p>You can report about problems to: 
 * <a href="mailto:martynas@idega.is">Martynas Stakė</a></p>
 *
 * @version 1.0.0 Nov 5, 2013
 * @author <a href="mailto:martynas@idega.is">Martynas Stakė</a>
 */
public class CourseProviderUsersTypeGroup {
	...
	public CourseProviderUsersTypeGroup() {};
	
	public CourseProviderUsersTypeGroup(
			CourseProviderUserType type,
			List<CourseProviderUserBean> beans) {
		if (type != null) {
			this.key = type.getPrimaryKey().toString();
	...
	public boolean add(CourseProviderUserBean bean) {
		if (bean == null) {
	...
	public void addAll(Collection<CourseProviderUserBean> beans) {
		if (!ListUtil.isEmpty(beans)) {
			for (CourseProviderUserBean bean : beans) {
				add(bean);
			}
		}
	}
