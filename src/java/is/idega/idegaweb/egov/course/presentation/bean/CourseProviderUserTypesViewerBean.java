...
import is.idega.idegaweb.egov.course.presentation.CourseProviderUserTypesViewer;
...
/**
 * <p>JSF managed bean for {@link CourseProviderUserTypesViewer}</p>
 ...
 */
public class CourseProviderUserTypesViewerBean {

	public List<CourseProviderUserTypeBean> getCourseProvidersUserTypes() {
		Collection<CourseProviderUserType> courseProviderUserTypes = getCourseProviderUserTypeHome().find();
		if (ListUtil.isEmpty(courseProviderUserTypes)) {
			return Collections.emptyList();
		}

		ArrayList<CourseProviderUserTypeBean> beans = new ArrayList<CourseProviderUserTypeBean>(courseProviderUserTypes.size());
		for (CourseProviderUserType courseProviderUserType : courseProviderUserTypes) {
			beans.add(new CourseProviderUserTypeBean(courseProviderUserType));
		}
	...
	public String getEditorLink() {
		return BuilderLogic.getInstance().getUriToObject(CourseProviderUserTypeEditor.class);
	}
	...
	public void remove(String courseProviderUserTypeId) {
		getCourseProviderUserTypeHome().remove(courseProviderUserTypeId);
	}
